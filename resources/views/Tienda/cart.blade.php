...
<body>
    ...
    <!-- ALL PLUGINS -->
    <script src="{{asset('jquery.superslides.min.js')}}"></script>
    <script src="{{asset('bootstrap-select.js')}}"></script>
    <script src="{{asset('inewsticker.js')}}"></script>
    <script src="{{asset('bootsnav.js')}}."></script>
    <script src="{{asset('images-loded.min.js')}}"></script>
    <script src="{{asset('isotope.min.js')}}"></script>
    <script src="{{asset('owl.carousel.min.js')}}"></script>
    <script src="{{asset('baguetteBox.min.js')}}"></script>
    <script src="{{asset('form-validator.min.js')}}"></script>
    <script src="{{asset('contact-form-script.js')}}"></script>
